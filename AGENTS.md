...
Before you think, plan or open any source file, read:

- `.sinapsi/session.md` (what happened)
- `.sinapsi/handoff.md` (current working state)

Rewriting `handoff.md` and appending `session.md` is the last action of every patch.
A patch that leaves either file stale is incomplete.
